...
describe("Service Identifiers", () => {
  describe("SERVICE_IDENTIFIERS", () => {
    ...
    it("should have descriptive symbol descriptions", () => {
      expect(SERVICE_IDENTIFIERS.USER_REPOSITORY.toString()).toContain(
        "UserRepository"
      );
      expect(SERVICE_IDENTIFIERS.CONNECTION_REPOSITORY.toString()).toContain(
        "ConnectionRepository"
      );
      expect(SERVICE_IDENTIFIERS.HEALTH_CHECK_REPOSITORY.toString()).toContain(
        "HealthCheckRepository"
      );
      expect(SERVICE_IDENTIFIERS.CHECK_RESULT_REPOSITORY.toString()).toContain(
        "CheckResultRepository"
      );
      expect(SERVICE_IDENTIFIERS.MONITORING_REPOSITORY.toString()).toContain(
        "MonitoringRepository"
      );

      expect(SERVICE_IDENTIFIERS.CONNECTION_SERVICE.toString()).toContain(
        "ConnectionService"
      );
      expect(SERVICE_IDENTIFIERS.HEALTH_CHECK_SERVICE.toString()).toContain(
        "HealthCheckService"
      );
      expect(SERVICE_IDENTIFIERS.DASHBOARD_SERVICE.toString()).toContain(
        "DashboardService"
      );
      expect(SERVICE_IDENTIFIERS.MONITORING_SERVICE.toString()).toContain(
        "MonitoringService"
      );
      expect(SERVICE_IDENTIFIERS.CRON_SERVICE.toString()).toContain(
        "CronService"
      );
      expect(SERVICE_IDENTIFIERS.SERIALIZATION_SERVICE.toString()).toContain(
  ...
  describe("symbol uniqueness", () => {
    ...
    it("should have different symbols for different services", () => {
      expect(SERVICE_IDENTIFIERS.USER_REPOSITORY).not.toBe(
        SERVICE_IDENTIFIERS.CONNECTION_REPOSITORY
      );
      expect(SERVICE_IDENTIFIERS.CONNECTION_SERVICE).not.toBe(
