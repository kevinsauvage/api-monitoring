...
export default function ConnectionUptimeChart({
  data,
  connectionName,
}: ConnectionUptimeChartProps) {
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription>
              {connectionName} uptime over the last 7 days
            </CardDescription>
          </div>
          ...
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={chartData}>
              ...
              <Area
                ...
                strokeWidth={2}
                fill="url(#connectionUptimeGradient)"
              />
            </AreaChart>
          </ResponsiveContainer>
        </div>
